/*
 Example of MQTT client – publishing a MQTT messages into public broker via Cinterion Connect Shield library.
...
const char* mqtt_client_topic = "LteTest";
...
/**
 * Function used for connection/reconnection with MQTT broker.
 */
void reconnect() 
{ 
...
void loop() 
{
  ...
  MqttClient.publish(mqtt_client_topic,"Hi there");
